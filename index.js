       ...
       if (message.content === prefix + "menu10"){
        ...
        if (message.content === prefix +"description"){
           ...
           var description_embed = new Discord.RichEmbed()
               .setColor('#' + (Math.random() * 0xFFFFFF << 0).toString(16))
               .addField("__Vous avez un petit creux ?__","Venez déguster un bon Hamburger ou partager une fondue !")
               .addField("__Pas le temps ?__","Des menus express existent !")
               ...
               .addField("Vous tapez la commande &bienvenue ","Et il vous guidera pour la suite !\n Un bot des plus réalistes créé par Jojojordyland et L'équipe Food 🍰 , qui va satisfaire tous les gourmands et les gourmandes !\n Bon app tout le monde :pizza: !")
